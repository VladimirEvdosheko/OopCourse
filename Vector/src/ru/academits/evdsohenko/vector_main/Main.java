...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("Result of multiply of vector and scalar is %s%n", vector1.multiplyByScalar(2));

        Vector subtractionResult = Vector.getDifference(vector1, vector2);
        ...
        double multiplyResult = Vector.getScalarProduct(vector1, vector3);
        System.out.printf("Vectors multiply result = %f%n", multiplyResult);

        System.out.printf("Subtract result of two vectors is %s%n", vector1.subtract(vector3));
    }
}